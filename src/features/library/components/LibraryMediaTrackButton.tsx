...
import { LibraryMediaTrackButtonProps } from '@/features/library/types/libraryMediaTrackButton';
...
export const LibraryMediaTrackButton: FC<LibraryMediaTrackButtonProps> = ({
  tmdbId,
  mediaType,
  className,
  unstyled,
