...
import { LibraryDetailsHeaderProps } from '@/features/library/types/libraryDetailsHeader';
...
import { LibraryShowStatusChangeButton } from '@/features/library/components/shows/LibraryShowStatusChangeButton';
import { LibraryMovieStatusChangeButton } from '@/features/library/components/movies/LibraryMovieStatusChangeButton';

export const LibraryDetailsHeader: FC<LibraryDetailsHeaderProps> = ({ media }) => {
