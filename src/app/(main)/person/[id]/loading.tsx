  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between border-b border-white/[0.08] pb-3">
        <div className="h-8 w-32 animate-pulse rounded-full border border-white/10 bg-white/[0.06]" />
        <div className="h-6 w-24 animate-pulse rounded-full border border-white/10 bg-white/[0.06]" />
      </div>
        ...
        <div className="relative z-10 flex flex-1 flex-col justify-between space-y-5">
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-2 pt-1">
              <div className="h-6 w-32 animate-pulse rounded-full border border-white/10 bg-white/[0.06]" />
              <div className="h-6 w-44 animate-pulse rounded-full border border-white/10 bg-white/[0.06]" />
              <div className="h-6 w-24 animate-pulse rounded-full border border-violet-500/25 bg-violet-500/15" />
              <div className="h-6 w-20 animate-pulse rounded-full border border-white/10 bg-white/[0.06]" />
            </div>
      ...
      <div className="space-y-4 pt-2">
        <div className="flex flex-col justify-between gap-4 border-b border-white/[0.08] pb-3 sm:flex-row sm:items-center">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4">
          {[1, 2, 3, 4, 5, 6, 7, 8].map((item) => (
            ...
            >
              {/* Poster Placeholder */}
              <div className="relative flex aspect-[2/3] w-full animate-pulse flex-col justify-between border-b border-white/[0.08] bg-zinc-800/80 p-3">
                <div className="flex items-start justify-between gap-2">
                  <div className="h-5 w-12 rounded-full bg-white/10" />
              ...
              <div className="space-y-2 p-3">
                ...
                <div className="border-t border-white/[0.08] pt-2">
                  <div className="h-7 w-full animate-pulse rounded-full bg-white/[0.06]" />
                </div>
              </div>
            </div>
          ))}
